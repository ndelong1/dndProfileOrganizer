# create a class that makes user profiles that can be browsed
import sqlite3 as sq
from player import Player
from rollAttribute import *

#Create blank list for each profile name
...
def add_user_profile(username, charactername, race, classType):
    pass
...
while run:
    ...
    add_profile = input("Would you like to create a new profile? (Y, N) >> ")
    ...
    if add_profile == "Y":
        ...
        "CREATE TABLE profile(username,character_name, race, class)",Player(NAME, RACE, CLASS_INFO))
        ...
        user_profile.set_attributes("strength", s)
        user_profile.set_attributes("dexterity", d)
        user_profile.set_attributes("constitution", c)
        user_profile.set_attributes("intelligence", i)
        user_profile.set_attributes("wisdom", w)
        user_profile.set_attributes("charisma", ch)
...
# print(user_profiles[0].get_player_info())
# print(user_profiles[0].set_attribute_mods())
# print(user_profiles[1].get_player_info())
# print(user_profiles[1].set_attribute_mods())
